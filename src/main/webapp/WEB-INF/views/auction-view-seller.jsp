...
<div class="w3-main" style="margin-left:300px">
  ...
  <c:forEach var="product" items="${requestScope.auctions}"> 
    <div class="w3-third w3-container w3-margin-bottom">
      ...
      <div class="w3-container w3-white">
        ...
        <form id="deleteForm/${product.name}/${product.id}" method="POST" action="${contextPath}/seller/auction/remove/${product.name}/${product.id}">
            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
            <button type="submit" class="w3-bar-item w3-button w3-padding">Remove from Auction</button>
        </form>
        <a href="${contextPath}/seller/products/edit/${product.name}/${product.id}" class="w3-bar-item w3-button w3-padding">Edit Auction</a>
      </div>
    </div>
    </c:forEach>
  </div>
