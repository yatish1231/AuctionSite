...
<div class="w3-main" style="margin-left:300px">
	  ...
	  <c:forEach var="product" items="${requestScope.productsActive}"> 
	    <div class="w3-third w3-container w3-margin-bottom">
	      ...
	      <div class="w3-container w3-white">
	        ...
	        <a href="${contextPath}/seller/auction/add" class="w3-bar-item w3-button w3-padding">Add to Auction Now</a>
	      </div>
	    </div>
	    </c:forEach>
	  </div>
  ...
  <div class="w3-black w3-center w3-padding-24">Project by<a href="https://www.w3schools.com/w3css/default.asp" title="W3.CSS" target="_blank" class="w3-hover-opacity">Yatish</a></div>
